...
type TaggerConfig struct {
	Endpoint string // Bifrost gateway URL (http://localhost:8080/v1/chat/completions)
	Model    string // Model name (e.g. "openai/gpt-4o-mini", "ollama/llama3.2")
	Enabled  bool   // Whether tag generation is active
}
